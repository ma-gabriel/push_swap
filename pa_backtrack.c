...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/06 00:30:01 by geymat            #+#    #+#             */
/*   Updated: 2024/01/13 13:17:50 by geymat           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_methode	*pa_back_p(int *a, int *b, int count)
{
	...
	actual->function_id = 0;
	return (max_methode(pa, back_r(a, b, count), actual, 0));
}
